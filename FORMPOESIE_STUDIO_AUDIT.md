...
- Rechnungsablauf um eine persistente Kundenkartei erweitert. Bestehende Kunden sind in der Kasse auswählbar, neue Kunden können beim Ausstellen gespeichert werden; die Rechnung bewahrt weiterhin einen unveränderlichen Kundendatenstand. Die fehlerhafte Schreibweise der Versandart bei allgemeinen Verkäufen wurde an die bestehende Datenbankregel angepasst.
